            ...
            "outputs" : [
                {
                    "quickreplies": {
                        ...
                        "action": this.res.action
                    }
                }

            ]
        }
        if(typeof this.res.action == "message") {
            res.outputs[0].quickreplies.messageText = this.res.messageText
        }else{
            res.outputs[0].quickreplies.blockId = this.res.blockId
        }
        return res;
    }
}
